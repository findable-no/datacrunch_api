...
CONTAINER_NAME = "sync-storage-v2"
IMAGE = "786001665406.dkr.ecr.eu-central-1.amazonaws.com/datacrunch:sync-storage-v2"
...
environ["MIN_REPLICA_COUNT"] = "1"
environ["MAX_REPLICA_COUNT"] = "1"  # in prod
